...
legend('Data points', 'PRINCESS', 'Gompertz','Logistic','vonBertalanffy','Holling');
legend('boxoff');
box off;
%% boxplot evaluation
...
g2 = repmat({'PRINCESS'}, length(y1neuro), 1);
...
models = 1:5;
names = {'PRINCESS'; 'Gompertz'; 'Logistic'; 'Bertalanffy'; 'Holling'};
